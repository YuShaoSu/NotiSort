...
public class FragmentRadioboxes extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_radioboxes, container, false);
    ...
    private void collect_data() {
        ...
        if (the_choice.length() > 0) {
            ESMAnswer.getInstance().put_answer(textview_q_title.getText().toString(), the_choice);
        }
